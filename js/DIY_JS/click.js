window.onload=()=>{
    ...
    body.onclick=function(e){//点击body时触发事件
        const a=["a", "b", "c", "d", "e", "f", "g", "h", "i", "g", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "V", "w", "x", "y", "z"];//需要显示的词语
        ...
        if (i%26!=22){
        span.style.cssText="z-index:999999999999999999999999;top:"+(y - 20)+"px;left:"+(x+40)+"px;position:absolute;font-weight:bold;color:#BCBCBC;";}
        else {
          span.style.cssText="z-index:999999999999999999999999;top:"+(y - 20)+"px;left:"+(x+40)+"px;position:absolute;font-weight:bold;font-size:200px;color:#F72515;";
        }//在鼠标的指针的位置给span标签添加css样式
